...
5. Now, enter the SQLVM **username**, **password** provided below and then click on **Ok** the button. Please add the **dot** and **back-slash** “.\” before the username.
...
10. Close all the windows and disconnect to the remote session of SQL VM.
 ...
 Now, click on **Next** in the bottom right corner of the lab guide section to jump to the next exercise instructions.
